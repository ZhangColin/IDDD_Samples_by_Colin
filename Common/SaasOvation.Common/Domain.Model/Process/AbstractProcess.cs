    ...
    public abstract class AbstractProcess: ConcurrencySafeEntity, IProcess {
        ...
        public TimeConstrainedProcessTracker TimeConstrainedProcessTracker {
            get {
                ...
                TimeConstrainedProcessTracker tracker = new TimeConstrainedProcessTracker(TenantId, ProcessId,
                    Description, StartTime, AllowableDuration, TotalRetriesPermitted,
